...
class collection:
    ...
    def plot_feature_importances(self, model, fold:int=None, kind:str='tree-shap', style:str='bar', ax=None, cut:float=2, sigma:float=2.576, median_hline:bool=False, save_path:str=None):
        ...
        if self.evaluation_approach == "k-fold" and fold is not None:
            ...
            plot_feature_importances(model=model, X_test=X_test, y_test=y_test, feature_names=feature_names, 
                                     ...
                                     mean_importances_df=mean_importances_df, importances_df=importances_df, median_hline=median_hline)
